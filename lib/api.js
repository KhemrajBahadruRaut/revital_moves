...
export const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_URL || "http://localhost/revital_moves";
...
export async function submitConsultation(payload) {
  const response = await api.post("/consultation/create_consultation.php", payload);
  return response.data;
}
...
export async function updateJobStatus(id, status) {
  const response = await api.post("/jobs/update_job_status.php", { id, status });
  return response.data;
}
...
export async function updateApplicationStatus(id, status) {
  const response = await api.post("/job_application/update_application_status.php", {
    id,
    status,
  });
  return response.data;
...
export async function deleteApplication(id) {
  const response = await api.post("/job_application/delete_application.php", { id });
  return response.data;
}
...
export async function updateConsultationStatus(id, status) {
  const response = await api.post("/consultation/update_consultation_status.php", {
    id,
    status,
  });
  return response.data;
...
export async function deleteConsultation(id) {
  const response = await api.post("/consultation/delete_consultation.php", { id });
  return response.data;
}
