...
const MissionVison = () => {
  return (
    <div className="max-w-7xl m-auto">
      <div className="flex  gap-5 sm:gap-12 mt-10 sm:mt-20 items-start  container mx-auto">
        {/* LEFT*/}
          {/* Text */}
          <div className="text-gray-600 text-justify sm:text-xl  space-y-4">
            <p>
        ...
        <div className="flex items-center gap-4 ">
            <div className="w-0.5 h-70 bg-[#000000]"></div>
